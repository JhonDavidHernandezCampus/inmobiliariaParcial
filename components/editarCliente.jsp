...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            String consultaMysql = "SELECT * FROM clientes WHERE id_cli = ?";
        ...
        <div class="formulario">
            ...
            <form action="./guardarEdicionClienteAdmin.jsp" method="POST" class="formulario">
                <input type="hidden" name="id_cli" value="<%= id_cli %>" />
                <div>
                    <label for="pnombre_cli">Primer Nombre:</label>
                    <input type="text" name="pnombre_cli" value="<%= pnombre_cli %>" />
                </div>
                <div>
                    <label for="snombre_cli">Segundo Nombre:</label>
                    <input type="text" name="snombre_cli" value="<%= snombre_cli %>" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="correo_cli" value="<%= correo_cli %>" />
                </div>
                <div>
