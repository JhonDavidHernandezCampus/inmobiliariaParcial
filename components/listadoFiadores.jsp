...
<head>
    ...
    <title>Listado de Fiadores</title>
</head>
<body>
    <header>
        <nav>
    ...
    <div class="container">
        ...
        <table>
            ...
            try {
                ...
                String consultaMysql = "SELECT * FROM fiadores";
                ...
                while(rs.next()) { 
                    %>
                    <tr>
                        <td><%= rs.getString("id_fia") %></td>
                        <td><%= rs.getString("pnombre_fia") %></td>
                        <td><%= rs.getString("snombre_fia") %></td>
                        <td><%= rs.getString("papellido_fia") %></td>
                        <td><%= rs.getString("sapellido_fia") %></td>
                        <td><%= rs.getString("correo_fia") %></td>
                        <td><%= rs.getString("num_telefono_fia") %></td>
                    </tr>
                    <% 
                }
